...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('designs')->group(function () {
        ...
        Route::post('/', [DesignController::class, 'store'])->middleware('admin_api');
        Route::patch('/{id}', [DesignController::class, 'update'])->middleware('admin_api');
        Route::delete('/{id}', [DesignController::class, 'destroy'])->middleware('admin_api');
    });
    ...
    Route::get('/request/{id}', [RequestController::class, 'showApi'])->middleware('designer_contractor_api');
    Route::get('/requests', [RequestController::class, 'indexApi'])->middleware('designer_contractor_api');
});